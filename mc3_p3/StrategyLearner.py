...
class StrategyLearner(object):
    ...
    def train(self): ##
        ...
        for iteration in range(0, 100):
            ...
            twentymean = 0
            money = True
            state = self.discretize(dr, tenmean, twentymean) #convert the features to a state
            ...
            while steps < data.count() - 1:
                ...
                state = self.discretize(dr, tenmean, twentymean)
        ...
        ''' tring to discritize the data;  #1 attempt: use the daily return from the nth day, and discretize it into maybe
        11 intervals, MVA10 > MVA20 or MVA10 < MVA20, a total of 22 states. '''
        ## added another factor to discretization: whether the agent has enough value left to buy.

        pass

    def discretize(self, dr, tenmean, twentymean):
        dr_count = 0
    ...
    def query(self,steps, dr, tenmean, twentymean):
        state = self.discretize(dr, tenmean, twentymean)
